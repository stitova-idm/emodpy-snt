...
# Rename "emodpy-snt" to "API reference"
...
latex_documents = [
    (master_doc, 'emodpy-snt-docs.tex', u'emodpy-snt',
...
man_pages = [
    (master_doc, 'emodpy-snt-docs', u'emodpy-snt',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'emodpy-snt-docs', u'emodpy-snt',
     author, 'Institute for Disease Modeling', 'How to use emodpy-snt for malaria simulations.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'python': ('https://docs.python.org/3', None),
                       ...
                       'emodpy_malaria': ('https://docs.idmod.org/projects/emodpy-malaria/en/latest/', None),
